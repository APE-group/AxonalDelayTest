# AxonalDelayTest
Test of the effects of axonal and dendritic delays in NEST
AxonalDelayTest
...
Point your environment to that NEST (ensure stdp_pl_synapse_hom_ax_delay exists).

Tweak config_sim_test_Ax_and_Dendr_Delay_STDP.yaml:
...
Use a standard NEST build (no axonal delay model).
